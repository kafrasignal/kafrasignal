  ...
  return (
    <main className={`min-h-screen ${isDark ? "bg-[#020617] text-white" : "bg-[#dbe5f3] text-[#0f172a]"}`}>
      ...
      <section id="pricing" className="mx-auto max-w-7xl px-6 py-20 text-center">
          ...
          {[
            ...
            >
              ...
              <ul className={`mb-6 min-h-[220px] space-y-2 text-left text-sm ${isDark ? "text-slate-300" : "text-slate-700"}`}>
                <li>â€¢ Realtime XAUUSD Signals</li>
                <li>â€¢ Scalping Every 30 Min</li>
                <li>â€¢ Intraday 6 Times</li>
                <li>â€¢ Tactical Risk Planner</li>
                <li>â€¢ Group Support Access</li>
        ...
        <p className={`mt-6 text-xs uppercase tracking-[0.14em] ${isDark ? "text-slate-500" : "text-slate-600"}`}>Secure Key â€¢ One Device Policy â€¢ Instant Access</p>
      </section>
